...
description: |
  A lower middle income country's performance in response to COVID-19 pandemic
author:
  - name: Yanhui LI
date: 08-30-2021
output:
...
<img src="https://www.history.com/.image/c_limit%2Ccs_srgb%2Cfl_progressive%2Ch_2000%2Cq_auto:good%2Cw_2000/MTYzOTQ2MTc0Njc4NzcxNTM3/egypt-gettyimages-1085205362.jpg" alt="drawing" class="center" style="width:100%" >
...
formattable(africadf, list(
    ...
    gdpCapita2010 = color_tile("transparent", "#7DCEA0")
    ),
    align = "c",
...
## COVID-19 Vaccinations in Egypt 💉
...
DT::datatable(egyvac, options = list(pageLength = 10),caption = "Table 3 ：Vaccinations information in Egypt")
```
